...
4) run `preload.py` and generate `population_V9.nq`,
5) pause and ask you to import `population_V9.nq` manually,
6) run `queries.py` and generate `queries_V6.nt`,
7) pause and ask you to import `queries_V6.nt` manually,
